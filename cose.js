...
function pageOpen() {
  ...
  // element.className += " newcard";
  element.classList.add("newcard");
  playAudio();
}
...
function pageClose() {
  var element = document.getElementById("cards");
  // element.className += " newcard";
  element.classList.remove("newcard");
}
...
function Check() {
  ...
  let result = classN.includes("newcard");
  console.log(result);
  if (result) {
    pageClose();
    ...
    myInterval = setInterval(function () {
      console.log(num += 1);
    //    let photos = document.getElementById("img-" + num);
    //    photos.style.display = "block";
       if (num > 37) {
         num = 0;
         let photos = document.getElementById("img-37");
         ...
         let photos = document.getElementById("img-" + num);
         photos.style.display = "block";
         photos = document.getElementById("img-" + (num - 1));
         photos.style.display = "none";
       } 
    }, 3000);
  }
...
function stackPhotos(arg) {
  let photos = document.getElementById("img-" + arg);
  photos.style.display = "block";
}
// /////////////////////////////////
